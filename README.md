# ANON Repository
This repository is part of the ANON project and contains the core data processing and analysis pipelines.

GUI program for automatically redacting information in pdf's
